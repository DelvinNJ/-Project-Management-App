...
export default function TasksTable({ routerName, projectId = null, tasks, queryParams = null, hideProjectColumn = false }) {
    ...
    const searchFieldChanged = (name, value) => {
        ...
        queryParams.page = 1;
        router.get(route(routerName, projectId), queryParams, {
            preserveScroll: true
        });
    }
